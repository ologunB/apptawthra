...
class TypeSelector6 extends StatefulWidget {
  @override
  _TypeSelectorState createState() => _TypeSelectorState();
}

class _TypeSelectorState extends State<TypeSelector6> {
  String programSelected, subsPeriod;
  bool isLoading = false;
  int selectedIndex;

  @override
  Widget build(BuildContext context) {
      selectedIndex = getPackages()[5]
        .programTitles
        .indexWhere((element) => element == programSelected);

    int length = getPackages()[5]
        .programDescs
        .indexWhere((element) => element == subsPeriod);
    return Scaffold(
                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: Text(
                              "Choose what you want to retweet".tr(),
                              style: GoogleFonts.nunito(
                                  fontSize: 16.0,
                                  color: Styles.colorBlack,
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: DropdownButton<String>(
                                ...
                                items:
                                    getPackages()[5].programTitles.map((value) {
      ...
      bottomNavigationBar: Container(
        ...
        child: CustomButton(
            color:
                programSelected == null ? Colors.grey : Styles.appPrimaryColor,
            title: "PAY NOW".tr(),
  ...
  Future payNow() async {
    ...
    await createCheckout().then((sessionId) {
      ...
      moveTo(
          ...
          CheckoutPage(
              sessionId: sessionId,
              successView: CreateTweetScreen6(
                program: selectedIndex,
                packageType: getPackages()[5].packageTitle,
              )));
    }).catchError((e) {
      print(e);
      print(e.message);
  ...
  Future<String> createCheckout() async {
    ...
    final body = {
      ...
      'line_items': [
        {
          'price': "price_1HzsG5LaLQ9qavQZJZgoTgEW",
          'quantity': 1,
        }
      ],
      'mode': 'payment',
