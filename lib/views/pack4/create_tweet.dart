...
class _CreateTweetScreenState extends State<CreateTweetScreen4> {
                  ...
                  onPressed: () {
                    ...
                    showDialog(
                        ...
                        builder: (context) => CustomDialog(
                            ...
                            body: Text(
                              "Are you sure you want to create Package 4 on ${sele.screen_name}?"
                                  .tr(),
  ...
  void completeCreateATweet(context) async {
    ...
    mData.putIfAbsent("package", () => "Package 4");
    mData.putIfAbsent("program", () => "Program ${alphabets[widget.program]}");
    mData.putIfAbsent("images", () => images);
    mData.putIfAbsent("daily rate", () => getPackages()[3].programDescs[widget.program]);
    ...
    try {
      Map data = {
        ...
        "number_of_tweets_per_day": getPackages()[3].programTitles[widget.program],
