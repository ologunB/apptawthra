...
class TypeSelector3 extends StatefulWidget {
  @override
  _TypeSelectorState createState() => _TypeSelectorState();
}

class _TypeSelectorState extends State<TypeSelector3> {
  ...
  Widget build(BuildContext context) {
    selectedIndex =
        getPackages()[2].programTitles.indexWhere((element) => element == numberOfTweets);

    int length = getPackages()[2].programDescs.indexWhere((element) => element == subsPeriod);
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: DropdownButton<String>(
                                ...
                                items: getPackages()[2].programTitles.map((value) {
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: DropdownButton<String>(
                                          ...
                                          iconEnabledColor: Colors.blueAccent,
                                          dropdownColor: Styles.whiteColor,
                                          items: getPackages()[2].programDescs.map((value) {
                                            return DropdownMenuItem<String>(
                                              value: value,
                                              child: Padding(
                                                padding:
  ...
  Future payNow() async {
    ...
    await createCheckout().then((sessionId) {
      ...
      moveTo(
          ...
          CheckoutPage(
              sessionId: sessionId,
              successView: CreateTweetScreen3(program: selectedIndex, subPeriod: subsPeriod)));
    }).catchError((e) {
      print(e);
      print(e.message);
    });
  ...
  Future<String> createCheckout() async {
    ...
    final body = {
      ...
      'line_items': [
        {
          'price': "price_1HzsE7LaLQ9qavQZ0y2NfaR1",
          'quantity': 1,
        }
      ],
      'mode': 'payment',
