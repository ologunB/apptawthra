...
class CreateTweetScreen3 extends StatefulWidget {
  final int program;
  final String subPeriod;

  CreateTweetScreen3({this.program, this.subPeriod});

  @override
  _CreateTweetScreenState createState() => _CreateTweetScreenState();
}

class _CreateTweetScreenState extends State<CreateTweetScreen3> {
