...
class _CreateTweetScreenState extends State<CreateTweetScreen2> {
                  ...
                  onPressed: () {
                    ...
                    showDialog(
                        ...
                        builder: (context) => CustomDialog(
                            ...
                            body: Text(
                              "Are you sure you want to create Package 2 on ${sele.screenName}?"
                                  .tr(),
  ...
  void completeCreateATweet(context) async {
    ...
    mData.putIfAbsent("package_name", () => "Package 2");
    ...
    mData.putIfAbsent("number_of_tweets_per_day",
        () => int.parse(getPackages()[1].programTitles[widget.program]));
    ...
    mData.putIfAbsent("desc", () => getPackages()[1].programDescs[widget.program]);
