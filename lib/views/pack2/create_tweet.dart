...
class CreateTweetScreen2 extends StatefulWidget {
  final int program;
  final String subPeriod;

  CreateTweetScreen2({Key key, this.program = 1, this.subPeriod});

  @override
  _CreateTweetScreenState createState() => _CreateTweetScreenState();
}

class _CreateTweetScreenState extends State<CreateTweetScreen2> {
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              bottom: AppBar(
                ...
                backgroundColor: Styles.appCanvasColor,
                title: Text(
                  "${"Package 2".tr()} - Program ${alphabets[widget.program]}",
                  style: GoogleFonts.nunito(
                  ...
                  onPressed: () {
                    ...
                    showDialog(
                        ...
                        builder: (context) => CustomDialog(
                            ...
                            body: Text(
                              "Are you sure you want to create Package 2 on ${sele.screen_name}?"
                                  .tr(),
  ...
  void completeCreateATweet(context) async {
    ...
    mData.putIfAbsent("package", () => "Package 2");
    mData.putIfAbsent("program", () => "Program ${alphabets[widget.program]}");
    mData.putIfAbsent("images", () => images);
    mData.putIfAbsent("daily rate", () => getPackages()[1].programDescs[widget.program]);
    ...
    mData.putIfAbsent("price", () => getPackages()[1].programPrices[widget.program]);
    ...
    try {
      Map data = {
        ...
        "number_of_tweets_per_day": getPackages()[1].programTitles[widget.program],
